...
class VoronoiPlotter:
    ...
    def create_ui(self):
        ...
        # Title
        title_label = ttk.Label(control_frame, text="Voronoi Diagram Plotter", font=('Helvetica', 14, 'bold'))
        title_label.pack(pady=(0, 20))
        
        # Instructions
        instruction_label = ttk.Label(control_frame, text="Click on the right panel to add sectors.\nThen click 'Generate Voronoi' to create the diagram.", wraplength=230)
        ...
        # Generate button
        self.generate_button = ttk.Button(buttons_frame, text="Generate Voronoi", command=self.generate_voronoi)
